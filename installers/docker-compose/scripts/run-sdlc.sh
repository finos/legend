...
# Run the server
java -Xmx2G -Xms256M -Xss4M -Djavax.net.ssl.trustStore=/ssl/truststore.jks -Djavax.net.ssl.trustStorePassword=$TRUSTSTORE_PASSWORD -Dfile.encoding=UTF8 -cp /app/bin/* org.finos.legend.sdlc.server.LegendSDLCServer server /config/config.yml