...
echo "  \"engine_image\": \"$LEGEND_OMNIBUS_ENGINE_IMAGE\"," >> /.buildinfo.json
echo "  \"sdlc_image\": \"$LEGEND_OMNIBUS_SDLC_IMAGE\"," >> /.buildinfo.json
echo "  \"pure_ide_image\": \"$LEGEND_OMNIBUS_PURE_IDE_IMAGE\"," >> /.buildinfo.json
echo "  \"studio_image\": \"$LEGEND_OMNIBUS_STUDIO_IMAGE\"" >> /.buildinfo.json
echo "}" >> /.buildinfo.json
