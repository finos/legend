...
docker build \
  ...
  --build-arg LEGEND_OMNIBUS_SDLC_PLATFORM_ENGINE_VERSION=$LEGEND_OMNIBUS_SDLC_PLATFORM_ENGINE_VERSION \
  --build-arg LEGEND_OMNIBUS_SDLC_PLATFORM_SDLC_VERSION=$LEGEND_OMNIBUS_SDLC_PLATFORM_SDLC_VERSION \
  \
