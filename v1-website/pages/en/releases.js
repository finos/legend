  ...
  return (
    <div className="docMainWrapper wrapper">
      <div style={{ marginTop: "7rem" }}>
        ...
        <p>
          Innnnnn the following table, we keep track of the details of each
          Legend release, which includes the changelog as well as the
          combination of versions for Studio, Engine and SDLC Docker images that
