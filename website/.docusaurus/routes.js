...
export default [
  ...
  },
  {
    ...
    routes: [
      ...
      {
        path: '/docs/showcases/graphql',
        component: ComponentCreator('/docs/showcases/graphql', 'b3d'),
        exact: true
      },
      {
      ...
      {
        path: '/docs/showcases/overview',
        component: ComponentCreator('/docs/showcases/overview', '752'),
        exact: true
      },
      {
        path: '/docs/tour',
